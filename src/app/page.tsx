...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 relative z-10"> {/* Ensure content is above the overlay */}
      <h1 className="text-4xl font-bold mb-6 text-white drop-shadow-md">HieloYa</h1> {/* Ensure heading is readable */}

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/sales">
          {/* Card component already has background set, text should be readable */}
